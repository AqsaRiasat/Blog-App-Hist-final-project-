...
4. Server-Side Dual-Image Media Uploads:
...
- Implemented AJAX fetch API calls communicating with includes/navigation_state.php to asynchronously verify session authentication and update site header actions dynamically with JSON responses without full page reloads.
...
3. Import Database:
   ...
   - Create a database named: 24870_aqsa_online_blogging_application
   - Import the SQL dump file located at: database/24870_aqsa_online_blogging_application.sql
...
Developed as the Final Project for Hidaya Institute of Science and Technology (HIST). Special thanks to the instructors and mentors for their guidance and support.
